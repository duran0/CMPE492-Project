...
\reportfigure[0.58\textwidth]{midterm_01_healthy_breast_cells.png}{Healthy breast cell visualization retained from the midterm report as biological context for HER2 signaling.}{fig:healthy_cells}
...
\reportfigure[0.58\textwidth]{midterm_02_malignant_cell.png}{Malignant cell visualization retained from the midterm report to motivate HER2-related biomarker monitoring.}{fig:malignant_cell}
...
\reportfigure[0.56\textwidth]{midterm_10_fet_operation.png}{Field-effect transistor operation diagram retained from the midterm report.}{fig:fet_operation}
...
\reportfigure{midterm_11_diffusion_model_geometry.png}{Diffusion-only geometry from the midterm stage, retained to show the original transport-model concept.}{fig:midterm_geometry}
...
\reportfigure{EXP_A_flow_vs_diffusion_sensor_exposure.png}{Experiment A sensor exposure for diffusion-only transport and prescribed-flow cases.}{fig:exp_a_flow}
...
\reportfigure{EXP_B_sensor_placement_deltaIds.png}{Experiment B GFET current response at 6000 s for the placement sweep.}{fig:exp_b_current}
...
\reportfigure{EXP_D_detectability_map_screened.png}{Experiment D screened detectability map under Debye attenuation assumptions.}{fig:exp_d_detectable}
