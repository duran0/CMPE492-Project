...
public class M3_surface_binding_full_boundary_v01 {
  public static Model run() {
    Model model = ModelUtil.create("Model");
    model.label("M3_surface_binding_full_boundary_v01.mph");
    ...
    model.param().set("A_full", "8e-10", "Full exposed boundary area assumption in m^2");
    ...
    model.component("comp1").geom("geom1").feature("sensor").label("full_boundary_sensor_placeholder");
    model.component("comp1").geom("geom1").feature("sensor").set("size", new String[]{"20", "40", "1"});
