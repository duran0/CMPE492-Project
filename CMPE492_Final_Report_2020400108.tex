...
The other ethical issue is scientific honesty. A simulation can guide engineering decisions, but it cannot prove clinical performance. For that reason, this report keeps the conclusion limited: the model predicts detectability only under specific physical and electronic assumptions.
